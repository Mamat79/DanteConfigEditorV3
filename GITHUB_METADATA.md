# Référence des métadonnées GitHub

Ce fichier conserve localement les textes éditoriaux actuellement réglés sur
GitHub. Il sert de repère pour les prochaines évolutions du dépôt. Les
...
- Statut : Release retirée à la demande du mainteneur lors de la promotion V3.2 ; tag et historique source conservés.
- La suppression volontaire de cette Release ne doit jamais être reproduite automatiquement par le workflow.
