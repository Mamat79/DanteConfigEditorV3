...
- Le modèle DMT original n'est jamais modifié et chaque changement est prévisualisé.

Cette application est un outil tiers non officiel Audinate et peut encore contenir des bugs. Travaillez sur une copie et validez le XML généré dans les outils Dante officiels.

**[Notes de version françaises complètes](https://github.com/Mamat79/DanteConfigEditorV3/blob/main/RELEASE_NOTES.md)**
...
- The original DMT template is never modified and every change is previewed.

This is an unofficial third-party tool, not affiliated with Audinate, and it may still contain bugs. Work on a copy and validate generated XML with official Dante tools.

**[Complete English release notes](https://github.com/Mamat79/DanteConfigEditorV3/blob/main/RELEASE_NOTES_EN.md)**
